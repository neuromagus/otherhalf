...
export default function MessageTable({ initialMessages, nextCursor }: Props) {
    const {
        columns, isOutbox, isDeleting, deleteMessage,
        selectRow, messages, loadMore, loadingMore, hasMore
    } = useMessages(initialMessages, nextCursor)

    return (
        <div className="flex flex-col h-[80vh] mr-4">
            <Card>
                <Table
                    ...
                    shadow="none"
                    className="flex flex-col gap-3 h-[80vh] overflow-auto mr-4"
                >
